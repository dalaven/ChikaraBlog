define([
	...
	const router = VueRouter.createRouter({
		...
		routes: [
			...
			{ name: "register:admin", path: "/admin/registro", component: m("enroll/index"), meta: { title: 'Inscripción' } },
			//{ name: "register:admin:course", path: "/admin/registro", component: m("enroll/course-admin"), meta: { title: 'Inscripción' } },
